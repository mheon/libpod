...
- Rootless Podman now supports setting resource limits on containers when the system uses CGroups V2 and the [crun](https://github.com/giuseppe/crun) OCI runtime
